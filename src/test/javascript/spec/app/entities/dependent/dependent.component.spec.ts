...
import { DependentComponent } from 'app/entities/dependent/dependent.component';
...
describe('Component Tests', () => {
  describe('Dependent Management Component', () => {
    let comp: DependentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DependentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dependents && comp.dependents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
