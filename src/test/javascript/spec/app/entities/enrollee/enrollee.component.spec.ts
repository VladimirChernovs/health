...
import { EnrolleeComponent } from 'app/entities/enrollee/enrollee.component';
...
describe('Component Tests', () => {
  describe('Enrollee Management Component', () => {
    let comp: EnrolleeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EnrolleeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.enrollees && comp.enrollees[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
